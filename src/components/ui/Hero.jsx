...
const HeroSection = () => {
  return (
    <header className="bg-[#fffaf4] py-10 px-5 sm:px-8 md:px-12 font-sans overflow-hidden">
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-center md:justify-start gap-3">
            <Link
              ...
              aria-label="Volunteer and change a life"
            >
            ...
            <Link
              ...
              aria-label="Donate and make an impact"
            >
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <img
            src="/bachhe.webp"
            alt="Children learning and receiving education"
            loading="lazy"
